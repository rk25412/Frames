...
public class WorkersController : Controller
{
    ...
    [HttpGet]
    public async Task<IActionResult> IsEmployeeNameTaken(string name)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateOrUpdateEmployee([FromBody] CreateWorkerDto workerDto)
    {
        try
        {
            Worker worker;
